...
(function () {
  ...
  function addStyles() {
    ...
    style.textContent = ".kds-popup{position:fixed;inset:0;z-index:2147483000;display:flex;align-items:center;justify-content:center;padding:16px;box-sizing:border-box}.kds-popup-backdrop{position:absolute;inset:0;background:rgba(0,0,0,.72);backdrop-filter:blur(4px)}.kds-popup-card{position:relative;width:100%;max-width:440px;overflow:hidden;border:1px solid #222;border-radius:16px;background:#0d0d0d;color:#fff;font-family:Arial,Helvetica,sans-serif;box-shadow:0 20px 60px rgba(0,0,0,.4)}.kds-popup-content{padding:30px 28px 14px}.kds-popup-brand{font-size:21px;font-weight:700}.kds-orange{color:#ff6a00}.kds-popup-eyebrow{margin-top:6px;font-size:10px;letter-spacing:1.5px;color:#fff}.kds-popup-badge{margin-top:26px;font-size:11px;font-weight:700;letter-spacing:2px;color:#ff6a00}.kds-popup-title{margin:10px 0 0;font-size:25px;line-height:1.2;color:#fff}.kds-popup-copy{margin:12px 0 0;color:#d4d4d4;font-size:14px;line-height:1.6}.kds-popup-actions{padding:20px 28px 28px;text-align:center}.kds-popup-close{position:absolute;right:12px;top:12px;width:32px;height:32px;border:0;border-radius:50%;background:#1a1a1a;color:#fff;font-size:20px;line-height:32px;cursor:pointer}.kds-popup-no{display:block;width:100%;margin-top:14px;border:0;background:transparent;color:#888;text-decoration:underline;cursor:pointer}.kds-cta{display:inline-block;padding:14px 26px;border-radius:8px;background:#ff6a00;color:#fff!important;text-decoration:none!important;font-weight:700;transition:transform .2s,background .2s}.kds-cta:hover{transform:translateY(-1px);background:#ff7b22}.kds-topline{height:5px;background:#ff6a00}.kds-bottomline{height:4px;background:#ff6a00}.kds-hidden{display:none!important}@media(max-width:520px){.kds-popup-content{padding-left:20px;padding-right:20px}.kds-popup-title{font-size:23px}}";
